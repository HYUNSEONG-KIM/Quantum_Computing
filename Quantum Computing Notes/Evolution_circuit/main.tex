...
\input{parts/formalization/discretization.tex}
\input{parts/formalization/time_evolution_operator.tex}
\input{parts/formalization/circuit_representation.tex}
%======================================================================================================================================

\newpage
\chapter{Optimization of evolution circuit}
\input{parts/optimization/optimization_circuit.tex}

%=====================================================================================================================================
\newpage
\part{Practical Examples}

\input{parts/practical/basic_simulation.tex}
\input{parts/practical/graph_and_ising.tex}
\input{parts/practical/adiabatic_simulation.tex}
\input{parts/practical/imaginary_evolution.tex}
\input{parts/practical/VQE.tex}
\input{parts/practical/Material_simulation.tex}
\input{parts/practical/ttp.tex}

%===================================
\newpage
\part{Further Topics}
\input{parts/further_topics/simulation.tex}
%======================================================================================================================================
\newpage
...
\input{appendix/unitary-hermite.tex}
\input{appendix/notation_int_qc.tex}
\input{appendix/fourier_transformation.tex}
\input{appendix/pauli_polynomial.tex}
\input{appendix/mathematics.tex}
\input{appendix/NP-problems.tex}
